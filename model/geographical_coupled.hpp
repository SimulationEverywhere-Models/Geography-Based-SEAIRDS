...
template <typename T>
class geographical_coupled : public cadmium::celldevs::cells_coupled<T, std::string, seaird, vicinity>
{
    public:

        explicit geographical_coupled(std::string const &id) : cells_coupled<T, std::string, seaird, vicinity>(id)
        {}
